...
- [sql-learning](./sql-learning): Databases and SQL for Data Science with Python (IBM). Módulos 1-4 con PostgreSQL.
  ...
  - [Modulo 4](./): Crear y acceder a base de datos SQLite con Python, crear tablas, insertar datos, consultar datos, trabajo con Pandas DataFrames, operaciones CRUD, gestión de conexiones.
